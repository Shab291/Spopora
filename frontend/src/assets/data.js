...
export const products = [
  ...
  {
    _id: "15",
    name: "Readme GT-NEO 2",
    description:
      "High-Tech Mobile 5g, ultra 8cors Snapdragon process, ultra-wide angle camera, Ultra gaming experience, long battery time.",
    price: 15,
    image: [img15],
    category: "Mobiles",
    colors: ["XS", "Black", "Red"],
  ...
  {
    _id: "22",
    name: "UltraBase Bluetooth Speaker",
    description:
  ...
  {
    _id: "43",
    name: "Wireless Premium Build + UltraBase + Noise Cancelling Headphones - Limited Edition",
    description:
      "Heavy duty premium, best quality build and noise-cancelling, designed for immersive listening on the go. Futuristic design and modern materials pushed headphone design forward ",
    price: 150,
    image: [headphones],
    category: "Headphones",
    colors: ["White"],
